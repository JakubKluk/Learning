...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.FREQ_HZ {125000000}  ] $sys_clock
  ...
  set_property -dict [ list CONFIG.CLKOUT1_JITTER {233.189} CONFIG.CLKOUT1_PHASE_ERROR {265.359} CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {200.000} CONFIG.MMCM_CLKFBOUT_MULT_F {32} CONFIG.MMCM_CLKOUT0_DIVIDE_F {4} CONFIG.PRIMITIVE {PLL}  ] $clk_wiz_0
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_ports hdmi_out_en] [get_bd_pins clk_wiz_0/reset] [get_bd_pins dvi2rgb_0/TMDS_Clk_n] [get_bd_pins dvi2rgb_0/TMDS_Clk_p] [get_bd_pins dvi2rgb_0/TMDS_Data_n] [get_bd_pins dvi2rgb_0/TMDS_Data_p] [get_bd_pins dvi2rgb_0/aRst] [get_bd_pins dvi2rgb_0/pRst] [get_bd_pins xlconstant_0/dout]
